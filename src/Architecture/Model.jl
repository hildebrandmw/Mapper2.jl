...
# function hash_builder(t::Type{T}, expr) where T <: AbstractPath
#     ex = [] 
#     for f in fieldnames(t)
#         if fieldtype(t, f) <: AbstractPath
#             append!(ex, hash_builder(fieldtype(t,f), :($expr.$f)))
#         else
#             push!(ex, :(u = hash($expr.$f,u)))
#         end
#     end
#     return ex
# end
